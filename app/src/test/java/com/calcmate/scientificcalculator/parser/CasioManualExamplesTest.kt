...
class CasioManualExamplesTest {
    ...
    fun `equation - cubic x3-2x2-x+2 roots are 2, 1, -1`() {
        val result = com.calcmate.scientificcalculator.core.math.EquationSolver
            .solveCubic(1.0, -2.0, -1.0, 2.0)
        assert(result is com.calcmate.scientificcalculator.core.math.CubicResult.ThreeRealRoots)
        val roots = result as com.calcmate.scientificcalculator.core.math.CubicResult.ThreeRealRoots
    ...
    fun `equation - quadratic 8x2-4x+5 complex roots 0_25 pm 0_75i`() {
        ...
        assert(result is com.calcmate.scientificcalculator.core.math.QuadraticResult.ComplexRoots)
        val roots = result as com.calcmate.scientificcalculator.core.math.QuadraticResult.ComplexRoots
    ...
    fun `equation - simultaneous 3x3 gives x=2 y=5 z=4`() {
        ...
        assert(result is com.calcmate.scientificcalculator.core.math.SystemResult3x3.Solution)
        val sol = result as com.calcmate.scientificcalculator.core.math.SystemResult3x3.Solution
